...
import { Permission } from '../../../../../@core/data/FashionShopApi.service';
import { PermissionService } from '../permission.service';

@Component({
  selector: 'ngx-permission-curd',
  templateUrl: './permission-curd.component.html',
  styleUrls: ['./permission-curd.component.scss']
})
export class PermissionCurdComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PermissionCurdComponent>
  ) { }

  statusAction = STATUS_ACTION;
  title: string = 'Lại Sản Phẩm';
  target: Permission = new Permission();
